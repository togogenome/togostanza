...
gem 'environment_inhabitants_statistics_brc_stanza', path: './environment_inhabitants_statistics_brc_stanza'
gem 'environment_organism_distribution_on_temperature_brc_nano_stanza', path: './environment_organism_distribution_on_temperature_brc_nano_stanza'
