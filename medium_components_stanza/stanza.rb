class MediumComponentsStanza < TogoStanza::Stanza::Base
  property :medium_information do |medium_id|
    medium_list = query("https://sparql-app.togogenome.org/sparql", <<-SPARQL.strip_heredoc)
    ...
    ingredient_list = query("https://sparql-app.togogenome.org/sparql", <<-SPARQL.strip_heredoc)
      PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
